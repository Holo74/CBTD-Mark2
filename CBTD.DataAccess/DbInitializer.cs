...
namespace CBTD.DataAccess
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
			...
			{
				UserName = "madelineknox@mail.weber.edu",
				Email = "madelineknox@mail.weber.edu",
				FirstName = "Dixon",
				LastName = "Boden",
				PhoneNumber = "8018823194",
			...
			ApplicationUser user = _db.ApplicationUsers.FirstOrDefault(u => u.Email == "madelineknox@mail.weber.edu");
